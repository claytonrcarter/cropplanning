...
public class CPSDataModelConstants {
   ...
   public static final int PROP_PLANTS_NEEDED = 61;
   public static final int PROP_ROWFT_PLANT   = 62;
   public static final int PROP_PLANTS_START  = 63;
   public static final int PROP_FLATS_NEEDED  = 64;   
   
   /* misc planting info */
   public static final int PROP_PLANTER = 70;
   public static final int PROP_PLANTER_SETTING = 71;
   public static final int PROP_LOCATION = 72;
   public static final int PROP_CROP_UNIT = 73;
   public static final int PROP_CROP_UNIT_VALUE = 74;
   
   /* yield info */
   public static final int PROP_YIELD_P_FOOT  = 80;
   public static final int PROP_TOTAL_YIELD   = 81;
