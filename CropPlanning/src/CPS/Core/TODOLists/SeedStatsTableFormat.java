...
public class SeedStatsTableFormat implements TableFormat<CPSPlanting> {
    ...
    public String getColumnName( int arg0 ) {
        ...
        switch ( arg0 ) {
            ...
            case 10: return "Seeds per Ft or Plant";
            case 11: return p.getDatum( CPSPlanting.PROP_SEED_UNIT ).getName();
            case 12: return p.getDatum( CPSPlanting.PROP_SEED_NEEDED ).getName();
            default: return "";
        }
    }
    ...
    public Object getColumnValue( CPSPlanting p, int arg1 ) {
      ...
      String s;
        ...
        switch ( arg1 ) {
            ...
            case 10: s = p.getSeedsPerString(); break;
            case 11: s = p.getSeedUnit(); break;
            case 12: s = p.getSeedNeededString(); break;
            default: s = "";
        }
